...
const Share = (props) => {
  ...
  return (
    <div>
      ...
      <a href="https://twitter.com/share?ref_src=www.google.com" className="twitter-share-button" data-show-count="false">Tweet</a><script async src="https://platform.twitter.com/widgets.js" charSet="utf-8"></script>
